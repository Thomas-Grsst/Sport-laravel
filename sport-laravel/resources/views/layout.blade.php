...
<body class="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 text-gray-800">
    ...
    <nav class="bg-blue-600 text-white py-4 shadow-lg">
        <div class="container mx-auto flex justify-center space-x-8 font-semibold">
            ...
            <a href="/create" class="hover:text-yellow-300 transition-colors {{Request::is('create') ? 'bg-blue-700 rounded-sm p-1' : ''}}">Créer</a>
    ...
    <footer class="absolute w-full bottom-0">
        <div class="bg-blue-600 text-white text-center py-4 mt-10">
